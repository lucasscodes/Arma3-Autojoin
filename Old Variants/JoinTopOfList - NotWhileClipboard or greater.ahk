...
^Insert::
{
	loadPartsForGUI()
	{
		static Gui, Add, Edit, x0 y-1 w35 h30
		static Gui, Add, UpDown, vMyUpDown +Range1-99, 95
		static Gui, Add, Button, x180 y-1 w65 h30 , Ok
		static Gui, Add, Text, x40 y-1 w125 h30 , Erste Zahl außerhalb des zulässigen Intervalls?
	...
	fehlgeschlagen()
	{
		...
		if (Var1 = 0x368921) and (Var2 = 0x368921) and (Var3 = 0x737373) and (Var4 = 0x737373) and (Var5 = 0xA6A6A6) and (Var6 = 0xD2D2D2) and (Var7 = 0xD2D2D2) and (Var8 = 0xFEFEFE) and (Var9 = 0xFEFEFE) and (Var10 = 0x4A4B4B) and (Var11 = 0x4B4C4E)
		{
			return true
		}
		else
